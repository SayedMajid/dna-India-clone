...
export const Business = () => {
  ...
  return (
    <div className="container1">
      <h1 style={{ fontSize: "30px", paddingBottom:"10px", fontWeight:"500"}}>Business</h1>
      {todos.map((todo, index) => (
        <div className="world11" key={todo.title}>
          <div className="w-25">
            <img className="w-100" src={todo.urlToImage} alt="" />
          </div>

          <Link to={`/Business2/${index}`} className=" w-75 p-1">
